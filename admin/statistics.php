...
<body>
    <div class="jumbotron text-center bg-success text-white m-0 p-3">
        <div class="row">
            <div class="col-sm-2">
                <img src="/images/sb-drustvo-logo.jpg" style="border-radius: 50%;" width="150px" height="150px">
            </div>
            <div class="col-sm-10 text-left">
                <h1 class="display-4">Statistika
                <i class="fas fa-user-cog"></i></h1>
                <p>* Omogućen uvid isključivo administratoru</p>
            </div>
        </div>
    </div>
                ...
                <?php 
                    if(isset($_SESSION['adminLoggedIn'])&&($_SESSION['adminLoggedIn']==true)){
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item active" href="statistics.php">Statistika <i class="fas fa-chart-line"></i></a>
                        </div>
                    </li>';
                    }
                ?>
    ...
    <h6 class="text-center p-2 mt-2">Sekcija kreirana. Očekivani prikazi statistika biti će dostupni u sljedećem update-u!</h6>
    <!--Footer-->
