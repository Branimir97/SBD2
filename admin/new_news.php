...
<body>
    <div class="jumbotron text-center bg-danger text-white m-0 p-3">
        <div class="row">
            ...
            <div class="col-sm-10 text-left">
                <h1 class="display-4">Postavljanje nove vijesti
            ...
            <ul class="navbar-nav">
                ...
                <?php 
                    if(isset($_SESSION['adminLoggedIn'])&&($_SESSION['adminLoggedIn']==true)){
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item active" href="new_news.php">Postavi novu vijest <i class="fas fa-newspaper"></i></a>
    ...
    <div class="container mt-3 mb-5">
        <form action="add_news_to_db.php" method="POST" enctype="multipart/form-data">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="title">Naslov vijesti</label>
                        <input type="text" class="form-control" maxlength="256" placeholder="Ovdje unesite naslov vijesti"
                            id="title" name="title" maxlength="40" required>
                    </div>
                    <div class="form-group">
                        <label for="preview">Kratki osvrt na vijest</label>
                        <textarea type="text" class="form-control" rows="5" placeholder="Ovdje unesite kratak osvrt na vijest"
                            id="preview" name="preview" required></textarea>
                    </div>
                    <input type="file" id="image" name="file" required>
                    <input type="checkbox" name="topnews"> Top vijest
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" rows="20" placeholder="Ovdje unesite puni sadržaj vijesti"
                            id="content" name="content" required></textarea>
                    </div>
                    <div class="text-center">
                        <button type="submit" name="submit" class="btn btn-primary">Postavi vijest</button> 
                    </div>
                </div>
            </div>
        </form>
