...
<head>
    ...
    <title>Dodaj novi live stream</title>

    <link rel="icon" href="../images/sb-drustvo-logo.jpg">
    <link rel="stylesheet" href="css/new_livestream.css">
...
<body>
    <div class="jumbotron text-center bg-danger text-white m-0 p-3">
        <div class="row">
            ...
            <div class="col-sm-10 text-left">
                <h1 class="display-4">Postavljanje novog live stream-a
                ...
                <?php 
                    if(isset($_SESSION['adminLoggedIn'])&&($_SESSION['adminLoggedIn']==true)){
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="new_match.php">Postavi novu utakmicu <i class="fas fa-history"></i></a>
                            <a class="dropdown-item active" href="new_livestream.php">Postavi novi live prijenos <i class="fab fa-youtube"></i></a>
    ...
    <div class="container mt-4">
        <form action="add_livestream_to_db.php" method="POST">
            <div class="form-group">
                <label for="title">Naslov live prijenosa</label>
                <input type="text" class="form-control" name="title" id="title" 
                    placeholder="Ovdje unesite naziv live prijenosa" maxlength="40" required>
            </div>
            <div class="form-group">
                <label for="link">Link videozapisa<br>
                    <span style="font-style:italic;">Format unosa linka: npr. link https://www.youtube.com/watch?v=Dzt1J1GzkKQ<br>
                            -> ukloniti tag watch?v= i postaviti tag embed/<br>
                            -> konačan primjer unosa navedenog linka: https://www.youtube.com/embed/Dzt1J1GzkKQ</span></label>
                <input type="text" class="form-control" name="link" id="title" 
                    placeholder="Ovdje unesite link videozapisa s platforme YouTube" required>
            </div>
            <button type="submit" class="btn btn-primary" name="submit">Postavi live prijenos
        </form>
    </div>
    <!--Footer-->
