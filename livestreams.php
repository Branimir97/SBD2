...
<?php
    ...
    $number_of_livestreams = mysqli_num_rows($result);
    ...
    $number_of_pages = ceil($number_of_livestreams / $results_per_page);
...
<head>
    ...
    <title>Live prijenosi</title>

    <link rel="icon" href="images/sb-drustvo-logo.jpg">
    <link rel="stylesheet" href="css/livestreams.css">
...
<body>
    <div class="jumbotron m-0 p-3">
        <div class="row">
            ...
            <div class="col-sm-10 text-left">
                <h1 class="display-4" style="color: darkblue;">Live prijenosi</h1>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item active" href="livestreams.php">Live prijenosi <i class="fab fa-youtube"></i></a>
                    </div>
                </li>
                <li class="nav-item">
    ...
    <!--Main part of live streames-->
    <div class="container-fluid mt-3">
        <h6 class="mb-3 text-center"><i class="fas fa-info-circle"></i>
            Ovo je nova rubrika na stranici. Pošto prije nije postojala, uskoro očekujte postavljanje live prijenosa. 
        </h6>
        <div class="row">
        <?php 
            $sql = "SELECT * FROM livestreams ORDER BY id DESC LIMIT ".$starting_limit_number.', '.$results_per_page;
            $result = mysqli_query($conn, $sql);
            ...
            if($resultCheck >= 1){
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    <div class="col-sm-4 mt-3 mb-3">
                        <div class="onelivestream">
                            <h5 class="text-center m-0 p-2 bg-secondary text-white">'.$row['title'].'</h5>
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe width="560" height="315" frameborder="0" allow="accelerometer; 
                                    autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen
                                    class="embed-responsive-item" src="'.$row['link'].'"></iframe>
                            </div>
                ...
                echo '
                    <h5 class="p-3 text-center">Trenutno nije objavljen niti jedan live prijenos.
        ...
        <ul class="pagination justify-content-center">
            <?php
                if($page == 1){
                    $disable_previos = 'disabled';
                }else{
                    $disable_previos = '';
                }
                echo '<li class="page-item '.$disable_previos.'">
                    <a class="page-link" href="livestreams.php?page='.$previos.'">&laquo Prethodna</a></li>'
            ?>
            <?php
                for($i = 1; $i <= $number_of_pages; $i++){
                    ...
                    echo '<li class="page-item '.$active.'">
                        <a class="page-link" href="livestreams.php?page='.$i.'">'.$i.'</a></li>';
                }
            ?>
            <?php
                ...
                echo '<li class="page-item '.$disable_next.'">
                    <a class="page-link" href="livestreams.php?page='.$next.'">Sljedeća &raquo</a></li>';
            ?>
        </ul>
    </div>
    <!--Footer-->
