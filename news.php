...
<?php
    ...
    $number_of_news = mysqli_num_rows($result);
    ...
    $number_of_pages = ceil($number_of_news / $results_per_page);
...
<body>
    <div class="jumbotron m-0 p-3">
        <div class="row">
            ...
            <div class="col-sm-10 text-left">
                <h1 class="display-4" style="color: darkblue;">Vijesti</h1>
    ...
    <div class="container-fluid mt-3">
        <h6 class="mb-4 text-center"><i class="fas fa-info-circle"></i> 
            Ovdje možete pročitati najznačajnije vijesti o kraljevskom klubu i njegovim igračima.   
        </h6>
        <div class="row">
            <?php
            $sql = "SELECT * FROM news ORDER BY id DESC LIMIT ".$starting_limit_number.','.$results_per_page;
            $result = mysqli_query($conn, $sql);
            $resultCheck = mysqli_num_rows($result);
            if($resultCheck >= 1){
                while($row = mysqli_fetch_assoc($result)){
                    echo '
                    <div class="col-sm-4" style="margin-bottom: 125px;">
                ...
                echo '
                    <h5 class="p-3 text-center">Trenutno nije objavljena niti jedna vijest.
                        Ukoliko se situacija nastavi pojavljivati kontaktirajte nas putem emaila: 
                        <a href="#">info@sbdrustvo.com</a></h5>';
            }
            ?>
        </div>
        <ul class="pagination justify-content-center">
            <?php
                ...
                echo '<li class="page-item '.$disable_previos.'">
                    <a class="page-link" href="news.php?page='.$previos.'">&laquo Prethodna</a></li>'
            ?>
            <?php
                for($i = 1; $i <= $number_of_pages; $i++){
                    ...
                    echo '<li class="page-item '.$active.'">
                        <a class="page-link" href="news.php?page='.$i.'">'.$i.'</a></li>';
                }
            ?>
            <?php
                ...
                echo '<li class="page-item '.$disable_next.'">
                    <a class="page-link" href="news.php?page='.$next.'">Sljedeća &raquo</a></li>';
            ?>
        </ul>
    </div>
